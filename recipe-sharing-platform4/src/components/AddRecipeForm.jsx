...
// // 🔥 Updated upload function: returns both public URL + file path
...
//     if (!steps.trim()) newErrors.steps = "Please list the preparation steps";
...
//         image_path: imageUploadResult.path, // ⭐ stores storage path
//         ingredients: ingredients.split("\n"),
//         steps: steps.split("\n"),
//         user_id: userId, // ⭐ stores recipe creator
//       },
//     ]);
...
//               className="w-full p-3 sm:p-4 border rounded-lg mt-2 bg-gray-100 dark:bg-gray-800 dark:text-white dark:border-gray-700 focus:ring-2 focus:ring-blue-500"

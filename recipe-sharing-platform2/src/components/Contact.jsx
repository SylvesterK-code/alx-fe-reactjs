        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <div
                  className="flex items-center border rounded-lg mt-1 px-3 py-3 
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full border rounded-lg mt-1 p-3 bg-gray-50 dark:bg-gray-700 
                             dark:border-gray-600 text-gray-800 dark:text-gray-200 outline-none"
                  required
                ></textarea>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl shadow-lg overflow-hidden h-64">
              <iframe
                title="map"
                // src="https://maps.app.goo.gl/ZWn3WcVkcZ6e6WPS7"
